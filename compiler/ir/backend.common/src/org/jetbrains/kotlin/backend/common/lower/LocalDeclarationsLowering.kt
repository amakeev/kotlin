...
open class LocalDeclarationsLowering(
    ...
    open fun getSuitableValueForCaptured(container: IrDeclaration, symbol: IrValueSymbol): IrValueDeclaration = symbol.owner
                ...
                val transformedNewTargetParameters = newTarget.parameters.map { newValueParameterDeclaration ->
                    ...
                    if (oldParameter != null) {
                        ...
                        localContext?.irGet(oldExpression.startOffset, oldExpression.endOffset, capturedValue) ?: run {
                            val value = oldParameterToNew[capturedValue] ?: getSuitableValueForCaptured(container, capturedValueSymbol)
