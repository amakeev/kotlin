...
internal class JvmLocalDeclarationsLowering(override val context: JvmBackendContext) : LocalDeclarationsLowering(
    ...
    override fun getSuitableValueForCaptured(container: IrDeclaration, symbol: IrValueSymbol): IrValueDeclaration {
        if (context.evaluatorData?.evaluatorGeneratedFunction == container && symbol.owner.parent != container) {
