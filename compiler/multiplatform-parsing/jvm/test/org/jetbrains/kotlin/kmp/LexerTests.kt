...
KDoc [7:1..10:4)
  ...
  KDOC_TEXT [8:3..4)
  KDOC_TAG_NAME [8:4..10)
  WHITE_SPACE [8:10..11)
  KDOC_MARKDOWN_LINK [8:11..16)
    LBRACKET [8:11..12)
    IDENTIFIER [8:12..13)
    DOT [8:13..14)
    IDENTIFIER [8:14..15)
  ...
  KDOC_TEXT [9:3..4)
  KDOC_TAG_NAME [9:4..11)
  WHITE_SPACE [9:11..12)
  KDOC_MARKDOWN_LINK [9:12..23)
    LBRACKET [9:12..13)
    IDENTIFIER [9:13..22)
    RBRACKET [9:22..23)
...
RBRACE [14:1..2)""", lexer.tokenize(kotlinCodeSample).dump(kotlinCodeSample.toSourceLinesMapping()))
    }
