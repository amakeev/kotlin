...
public class Flags {
    ...
    public static final BooleanFlagField HAS_MUST_USE_RETURN_VALUE = FlagField.booleanAfter(IS_FUNCTION_WITH_NON_STABLE_PARAMETER_NAMES);
    ...
    public static int getFunctionFlags(
        ...
        return HAS_ANNOTATIONS.toFlags(hasAnnotations)
               ...
               | HAS_MUST_USE_RETURN_VALUE.toFlags(isMustUseReturnValue)
                ;
    }
    ...
    public static int getPropertyFlags(
        ...
        return HAS_ANNOTATIONS.toFlags(hasAnnotations)
               ...
               | HAS_MUST_USE_RETURN_VALUE_PROPERTY.toFlags(isMustUseReturnValue)
                ;
    }
